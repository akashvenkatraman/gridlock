# Pitch Script: Project GRIDLOCK (The Ultimate Forensic Pitch)
## Team: Data Masters | Event: Analytics Showdown 4.0

---

## **OPENING: The $1.8 Billion Blind Spot (Scroll 0%)**
**Speaker**: *Akash*
...
- We flagged **8,342 vulnerable user crashes** (Cyclists & Pedestrians)—Vision Zero's top priority.
- And crucially, we recovered **24,500 missing coordinates**."

---

## **PART 2: The Reveal (Scroll 40%)**
**Speaker**: *Harish*
...
## **PART 3: Hidden Dangers (Scroll 60%)**
**Speaker**: *Harish*
...
And looking at our **Seasonality Timeline**, we see specific spikes that correlate with sensor failures and holiday traffic. We can now predict these surges."

---

## **PART 4: Native Analytics (Scroll 80%)**
**Speaker**: *Akash*
*(Scroll to "Crash Analytics")*

"Our native analytics engine now runs on the clean, engineered data.
- **Brooklyn** is the highest risk borough—it needs a $200K sensor upgrade immediately.
- **Peak Danger** is at **5:00 PM**.
- **Driver Inattention** is the #1 cause (28% of crashes).

We can finally see the truth."

---

## **CLOSING: The Future Outlook (Scroll 95%)**
**Speaker**: *Akash*
...
**Our Recommendation:**
Shift **$270 million**—just 15% of the Vision Zero budget—to the high-risk corridors we recovered today.
We project this will result in a **30-40% reduction** in highway fatalities by 2028.
